...
/**
* Interface for iterators of pseudorandom numbers drawn from a Fréchet distribution.
*/
...
* // ...
*/
declare function iterator( alpha: number, s: number, options?: Options ): RandIter; // tslint:disable-line:max-line-length
