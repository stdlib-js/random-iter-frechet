...
> Create an iterator for generating pseudorandom numbers drawn from a [Fréchet][frechet] distribution.
...
```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-frechet@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-iter-frechet/tags). For example,

```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-frechet@v0.2.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterator = require( 'path/to/vendor/umd/random-iter-frechet/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-frechet@umd/browser.js"></script>
```
...
Returns an iterator for generating pseudorandom numbers drawn from a [Fréchet][frechet] distribution with parameters `alpha` (shape parameter), `s` (scale parameter), and `m` (location parameter).

```javascript
var it = iterator( 2.0, 5.0, 3.0 );
// returns <Object>
...
If `alpha <= 0` or `s <= 0`, the function throws an error.

<!-- run throws: true -->

```javascript
var it = iterator( -1.0, 1.0, 0.0 );
// throws <TypeError>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-iter-frechet.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-iter-frechet

[test-image]: https://github.com/stdlib-js/random-iter-frechet/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/random-iter-frechet/actions/workflows/test.yml?query=branch:v0.2.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-iter-frechet/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-iter-frechet?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-iter-frechet.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-iter-frechet/main
...
[branches-url]: https://github.com/stdlib-js/random-iter-frechet/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-iter-frechet/main/LICENSE
